...
blocJams.service('SongPlayer', ['$rootScope', function($rootScope) {
  ...
  return {
    ...
    seek: function(time) {
      // check to make sure a song is playing before seeking
      if (currentSoundFile) {
        // use Buzz setTime method to set the time of the song
...
blocJams.directive('slider', ['$document', function($document) {
  ...
  return {
    ...
    restrict: 'E',
    scope: {
      onChange: '&' // evaluate the passed-in value as an expression in the parent scope
    }, // scope exists only in this directive
